...
.equ    PORTD_S1    = 0b10010000 // A VERDE(20), B VERDE(20 TROCA), C VERMELHO(70), D VERMELHO(20)
.equ    PORTD_S2    = 0b01010000 // A VERDE(25), B AMARELO(5 TROCA), C VERMELHO(75 TROCA), D VERMELHO(25)
.equ    PORTD_S3    = 0b00110000 // A VERDE(85 TROCA), B VERMELHO(60), C VERDE(60 TROCA), D VERMELHO(85)
.equ    PORTD_S4    = 0b00101000 // A AMARELO(5 TROCA), B VERMELHO(65), C AMARELO(5 TROCA), D VERMELHO(90)
.equ    PORTD_S5    = 0b00100100 // A VERMELHO(20), B VERMELHO(85), C VERMELHO(20), D VERMELHO(110 TROCA)
.equ    PORTD_S6    = 0b00100100 // A VERMELHO(45), B VERMELHO(110), C VERMELHO(45), D VERDE(25 TROCA)
.equ    PORTD_S7    = 0b00100100 // A VERMELHO(50 TROCA), B VERMELHO(115 TROCA), C VERMELHO(50), D AMARELO(5 TROCA)
//.equ    PORTD_S8    = 0b00100000 // A VERDE(20), B VERDE(20 TROCA), C VERMELHO(70), D VERMELHO(20)
//.equ    PORTD_S9    = 0b00110000 // A VERDE(25), B AMARELO(5), C VERMELHO(75 TROCA), D VERMELHO(25)
...
.equ    PORTB_S5    = 0b00001001 // A VERMELHO(20), B VERMELHO(85), C VERMELHO(20), D VERMELHO(110 TROCA)
.equ    PORTB_S6    = 0b00100001 // A VERMELHO(45), B VERMELHO(110), C VERMELHO(45), D VERDE(25 TROCA)
.equ    PORTB_S7    = 0b00010001 // A VERMELHO(50 TROCA), B VERMELHO(115 TROCA), C VERMELHO(50), D AMARELO(5 TROCA)
//.equ    PORTB_S8    = 0b00010001 // A VERDE(20), B VERDE(20 TROCA), C VERMELHO(70), D VERMELHO(20)
//.equ    PORTB_S9    = 0b00001001 // A VERDE(25), B AMARELO(5), C VERMELHO(75 TROCA), D VERMELHO(25)
